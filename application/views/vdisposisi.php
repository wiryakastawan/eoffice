                ...
                <div class="col-md-5 col-lg-5">
                    ...
                    foreach($data_disposisi as $hasil)
                	{
                		...
                		?>
                                            ...
                                            <a href="<?=base_url()?>/uploads/surat/<?php echo $hasil->file ?>" data-sub-html="Tampilan Surat"><img src="<?=base_url()?>/uploads/surat/<?php echo $filename ?>" height="1024" width="500" class="img-responsive thumbnail" align="center" alt="Klik Untuk Memperbesar"> 
                                            </a>
                        ...
                        <?php}
                          ...
                          <?php
                           ...
                           <?php
                            	     ...
                            	     ?>
                            	     <embed src="<?=base_url()?>uploads/surat/<?php echo $filename ?>" width="480" height="900"> </embed>
    ...
    $(this).datepicker('hide');
                ...
                <div class="col-md-5">
                	<div class="card">
                        ...
                        <div class="body">
                        	<form id="tambahdisposisi" action="<?=base_url()?>index.php/disposisi/simpan" method="post">
                        	...
                        	<p>
                        	<?php foreach($data_kabid as $hasilkabid)
                              	{
                           ...
                           <tr>
                           	...
                           	<input type="checkbox" class="filled-in chk-col-light-blue" id="kabid<?php echo $hasilkabid->id_bidang ?>" name="kabid[]" value="<?php echo $hasilkabid->id_bidang?>"  />
                           ...
                           <tr><td></td></tr>
                            ...
                            <?php foreach($data_kasi as $hasilkasi)
                		     ...
                		     <tr>
                		     	<td>
                                 <input type="checkbox" name="kasi[]" id="kasi<?php echo $hasilkasi->id_kasi ?>" value="<?php echo $hasilkasi->id_kasi ?>" class="filled-in chk-col-light-green"/>
					   ...
					   <div class="form-group">
	                       ...
	                       <input type="text" name="tgl_disposisi" class="form-control" placeholder="Tanggal Disposisi" id="tgl_disposisi" value="<?php echo $tglnow;?>" required>
	                       </div>
					   ...
					   <div class="form-group">
					   	<div class="form-line">
	                       <textarea rows="1" class="form-control no-resize" name="isi" placeholder="Masukkan Instruksi Disposisi..." required></textarea>
	                   </div>
	                   </div>
                       <?php
                       $jamsekrg=date('H:i:s');
